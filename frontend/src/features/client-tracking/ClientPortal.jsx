    ...
    <div className="min-h-screen w-full bg-[#F8FAFC] font-sans text-slate-900 antialiased">
      ...
      <header className="sticky top-0 z-20 border-b border-slate-200 bg-white px-5 py-3">
        <div className="mx-auto flex max-w-7xl items-center gap-4">
          <div className="flex shrink-0 items-center gap-2">
            ...
            <span className="text-lg font-extrabold tracking-tight">Pulse<span className="text-slate-400">Port</span></span>
          </div>
      ...
      <main className="mx-auto max-w-7xl px-5 py-6">
        ...
        <footer className="mt-8 text-center text-xs text-slate-400">
          PulsePort · widoczność łańcucha dostaw w czasie rzeczywistym
        </footer>
      </main>
    </div>
  );
